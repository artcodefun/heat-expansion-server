...
func NewModule() *Module {
	...
	grpcCommands := grpcapi.Commands{ArmyPrototype: commands.Prototype, BuildPrototype: commands.Prototype, StoragePrototype: commands.Prototype}
	grpcQueries := grpcapi.Queries{ArmyPrototype: queries.Prototype, BuildPrototype: queries.Prototype, StoragePrototype: queries.Prototype}
