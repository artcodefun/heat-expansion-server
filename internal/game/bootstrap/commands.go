...
func NewCommands(a *Adapters, as *AppServices) *Commands {
	return &Commands{
		...
		User:        commands.NewUserCommands(a.Users, a.CrystalCredits, a.OutboxEvents, a.TxMgr),
		BlackMarket: commands.NewBlackMarketCommands(a.Users, a.UserBases, a.BlackMarketOffers, a.BuildPrototypes, a.ArmyPrototypes, a.StoragePrototypes, a.OutboxEvents, a.Scheduler, a.TxMgr, as.Access),
		...
		Prototype:   commands.NewPrototypeCommands(a.ArmyPrototypes, a.BuildPrototypes, a.StoragePrototypes, a.TechPrototypes, a.TxMgr),
	}
}
